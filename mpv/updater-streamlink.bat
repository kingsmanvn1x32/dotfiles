...
if exist "%~dp0\installer\updater-streamlink-pw.ps1" (
    set updater-streamlink-pw_script="%~dp0\installer\updater-streamlink-pw.ps1"
) else (
    set updater-streamlink-pw_script="%~dp0\updater-streamlink-pw.ps1"
)
powershell -noprofile -nologo -executionpolicy bypass -File %updater-streamlink-pw_script%
